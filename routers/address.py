...
async def Add_address(user_id: int, addressdata: AddressSchema.AddressData,
                      db: Session = Depends(get_db),
                      current_user: UserSchema.FinalUserData = Depends(user_functions.get_current_active_user)):
...
@router.patch("/edit_address/{address_id}", response_model=AddressSchema.FinalAddressData)
async def edit_address(addressdata: AddressSchema.AddressData,
